...
1.0 FEATURE [FINAL VERSION]: 
    ...
    (1.0.10) =&gt; {
        - (ERROR FIX) MINNOR TEXT CHANGE: ADDED "(RE)" TO THE USERSCRIPT NAME 
        - (ERROR FIX) NOT ON TOP: NOW THE PLAYER WINDOW SHOWS ABOVE EVERYTHING IN THE PAGE.
    }
    (1.0.9) =&gt; {
...
window.PJSMP_mp__translate = (text) = & gt; {
...
window.PJSMP_mp__convertHex = (hex, opacity) = & gt; {
    if (hex.length == 4) {
...
window.PJSMP_mp__setBtnTextColor = (button, color, blur) = & gt; { //SET BUTTON COLLOR
...
var PJSMP_mp__NPS_interval = setInterval(() = & gt; { //NOTES PER SECOND
...
if (!document.querySelector("#PJSMP_mp__mainContainer")) {
    ...
    PJSMP_mp__mainContainer.style.zIndex = 10000000;
    document.body.appendChild(PJSMP_mp__mainContainer);
}
...
window.PJSMP_mp__dragElement = (elmnt) = & gt; { //DRAG AND DROP PROGRAM WINDOW
    var pos1 = 0,
        pos2 = 0,
        pos3 = 0,
        pos4 = 0;
...
window.PJSMP_mp__minimizeWindow = (e) = & gt; { //MINIMIZE WINDOW
...
window.PJSMP_mp__openChangelog = () = & gt; { //OPEN CHANGELOG
...
window.PJSMP_mp__optionsBtnHandler = (e, control) = & gt; { //OPTION CONTROLLERS HANDLER
    control.state = !control.state;

    PJSMP_mp__setBtnTextColor(e, control.state ? PJSMP_mp__colors.on : PJSMP_mp__colors.off);
}

window.PJSMP_mp__originControllersHandler = (e, control) = & gt; { //ORIGIN CONTROLLERS HANDLER
    if (e.tagName == "BUTTON") {
...
window.PJSMP_mp__sliderHandler = (e, control) = & gt; { //SLIDERS HANDLER
    if (e.tagName == "BUTTON") {
        if (e.innerHTML == PJSMP_mp__translate("fix")) {
...
window.PJSMP_mp__playPauseButtonClick = (e) = & gt; { //PLAY/PAUSE
...
window.PJSMP_mp__stopButtonClick = () = & gt; { //STOP  
...
window.PJSMP_mp__renderMidi = (file, qType) = & gt; { //RENDER MIDI
    file.tracks.forEach(track = & gt; {
...
window.PJSMP_mp__playPauseFunction = (action, qType) = & gt; { //PLAY/PAUSE
    if (typeof PJSMP_mp__midiJSONobject != "undefined") {
        if (action == "play") {
            PJSMP_mp__renderMidi(PJSMP_mp__midiJSONobject, qType);

            PJSMP_mp__stopInterval = setTimeout(() = & gt; {
            ...
            PJSMP_mp__notesArr.forEach(e = & gt; {
                clearInterval(e);
            });
            PJSMP_mp__notesArr = [];
...
window.PJSMP_mp__stopFunction = (action, qType) = & gt; { //STOP
    PJSMP_mp__notesArr.forEach(e = & gt; {
        clearInterval(e);
    });
    PJSMP_mp__resetVars();
...
window.PJSMP_mp__noNoteQuotaObj = {
    doOnce: true
};
window.PJSMP_mp__renderTrack = (track, qType) = & gt; { //RENDER TRACKS
    try {
        var endTrack = track.notes.filter(e = & gt; e.time & gt; = PJSMP_mp__pauseActualNote / 1000);
        endTrack.forEach(note = & gt; {
            ...
            if (qType == "load") {
                ...
                PJSMP_mp__notesArr.push(setTimeout(() = & gt; {
...
window.PJSMP_mp__calcSpeed = (time) = & gt; { //CALCULATE SPEED
...
window.PJSMP_mp__resetVars = () = & gt; { //RESET VARIABLES
    PJSMP_mp__notesArr = [];
    PJSMP_mp__actualNote = PJSMP_mp__pauseActualNote = 0;
    clearInterval(PJSMP_mp__stopInterval);
}

window.PJSMP_mp__setFileName = (name) = & gt; { //SET FILE NAME
    document.querySelector("#PJSMP_mp__fileDropContainer #PJSMP_mp__fileDropContainer_textContainer_text").textContent = name;
}

window.PJSMP_mp__keyPress = (note, release) = & gt; { //MPP.PRESS FUNCTION OVERIDE
...
window.PJSMP_mp__calcDuration = () = & gt; { //CALCULATE DURATION
...
window.PJSMP_mp__setDurationInfo = () = & gt; { //DISPLAY DURATION
    if (PJSMP_mp__fileName !== "none") {
...
if (!(window.File & amp; & amp; window.FileReader & amp; & amp; window.FileList & amp; & amp; window.Blob)) {
    ...
    document.querySelector("#PJSMP_mp__fileDropContainer input").addEventListener("change", e = & gt; {
...
window.PJSMP_mp__parseMidi = (file) = & gt; {
...
//MIDI TO JSON
! function (t, e) {
    if ("object" == typeof exports & amp; & amp;
        "object" == typeof module) module.exports = e();
    else if ("function" == typeof define & amp; & amp; define.amd) define([], e);
    else {
        var r = e();
    ...
    return function (t) {
        ...
        return r.m = t, r.c = e, r.d = function (t, e, n) {
            ...
            if (1 & amp; e & amp; & amp;
                (t = r(t)), 8 & amp; e) return t;
            if (4 & amp; e & amp; & amp;
                "object" == typeof t & amp; & amp; t & amp; & amp; t.__esModule) return t;
        ...
        var a = function () {
            function t(t) {
                var r = this;
                this.tempos = [], this.timeSignatures = [], this.keySignatures = [], this.meta = [], this.name = "", i.set(this, 480), t & amp; & amp;
                (i.set(this, t.header.ticksPerBeat), t.tracks[0].forEach(function (t) {
                    t.meta & amp; & amp;
                    ("timeSignature" === t.type ? r.timeSignatures.push({
                        ...
                        ticks: t.absoluteTime
                    }) : "trackName" === t.type ? r.name = t.text : "endOfTrack" !== t.type & amp; & amp; r.meta.push({
                        text: t.text,
                        ticks: t.absoluteTime,
                        type: t.type
                    }))
            ...
            return t.prototype.update = function () {
                ...
                this.tempos.sort(function (t, e) {
                    ...
                    var a = i & gt;
                    0 ? t.tempos[i - 1].bpm : t.tempos[0].bpm, o = n.ticks / t.ppq - r, s = 60 / a * o;
                    n.time = s + e, e = n.time, r += o
                }), this.timeSignatures.sort(function (t, e) {
                    return t.ticks - e.ticks
                }), this.timeSignatures.forEach(function (e, r) {
                    var n = r & gt;
                    0 ? t.timeSignatures[r - 1] : t.timeSignatures[0], i = (e.ticks - n.ticks) / t.ppq / n.timeSignature[0] / (n.timeSignature[1] / 4);
        ...
        function n(t, e, r) {
            ...
            var n = 0,
                i = t.length,
                a = i;
            if (i & gt; 0 & amp; & amp; t[i - 1][r] & lt; = e) return i - 1;
            for (; n & lt; a;) {
                var o = Math.floor(n + (a - n) / 2),
                    s = t[o],
                    u = t[o + 1];
                if (s[r] === e) {
                    for (var c = o; c & lt; t.length; c++) {
                        t[c][r] === e & amp; & amp;
                        (o = c)
                    }
                    return o
                }
                if (s[r] & lt; e & amp; & amp; u[r] & gt; e) return o;
                s[r] & gt;
                e ? a = o : s[r] & lt;
                e & amp; & amp;
                (n = o + 1)
        ...
        "use strict";
        var n = this & amp; & amp;
        this.__awaiter || function (t, e, r, n) {
        ...
        this.__generator || function (t, e) {
            var r, n, i, a, o = {
                label: 0,
                sent: function () {
                    if (1 & amp; i[0]) throw i[1];
                    return i[1]
                },
                trys: [],
                ops: []
            ...
            function s(a) {
                return function (s) {
                    return function (a) {
                        ...
                        for (; o;) try {
                            if (r = 1, n & amp; & amp;
                                (i = 2 & amp; a[0] ? n.return : a[0] ? n.throw || ((i = n.return) & amp; & amp; i.call(n), 0) : n.next) & amp; & amp; !(i = i.call(n, a[1])).done) return i;
                            switch (n = 0, i & amp; & amp;
                                (a = [2 & amp;a[0], i.value]), a[0]) {
                            case 0:
                            case 1:
                                i = a;
                                break;
                            ...
                            case 7:
                                ...
                                continue;
                            default:
                                if (!(i = (i = o.trys).length & gt; 0 & amp; & amp; i[i.length - 1]) & amp; & amp;
                                    (6 === a[0] || 2 === a[0])) {
                                    o = 0;
                                    continue
                                }
                                if (3 === a[0] & amp; & amp;
                                    (!i || a[1] & gt; i[0] & amp; & amp; a[1] & lt; i[3])) {
                                    o.label = a[1];
                                    break
                                }
                                if (6 === a[0] & amp; & amp; o.label & lt; i[1]) {
                                    o.label = i[1], i = a;
                                    break
                                }
                                if (i & amp; & amp; o.label & lt; i[2]) {
            ...
            c = function () {
                function t(t) {
                    var e = this,
                        r = null;
                    t & amp; & amp;
                    (t instanceof ArrayBuffer & amp; & amp;
                        (t = new Uint8Array(t)), (r = a.parseMidi(t)).tracks.forEach(function (t) {
                            var e = 0;
                            t.forEach(function (t) {
                                e += t.deltaTime, t.absoluteTime = e
                            })
                        })), this.header = new s.Header(r), this.tracks = [], t & amp; & amp;
                    (this.tracks = r.tracks.map(function (t) {
                        return new u.Track(t, e.header)
                    }), 1 === r.header.format & amp; & amp; 0 === this.tracks[0].duration & amp; & amp; this.tracks.shift())
                }
                ...
                if (240 == (240 & amp; n)) {
                    ...
                    case 84:
                        ...
                        return t.frameRate = {
                            ...
                            64: 29,
                            96: 30
                        } [96 & amp;o], t.hour = 31 & amp;
                        o, t.min = r.readUInt8(), t.sec = r.readUInt8(), t.frame = r.readUInt8(), t.subFrame = r.readUInt8(), t;
                    case 88:
                        if (t.type = "timeSignature", 4 != a) throw "Expected length for timeSignature event is 4, got " + a;
                        return t.numerator = r.readUInt8(), t.denominator = 1 & lt; & lt;
                        r.readUInt8(), t.metronome = r.readUInt8(), t.thirtyseconds = r.readUInt8(), t;
                    case 89:
                    ...
                    var u = n & gt; & gt;
                    4;
                    switch (t.channel = 15 & amp; n, u) {
                    case 8:
                        return t.type = "noteOff", t.noteNumber = s, t.velocity = r.readUInt8(), t;
                    case 9:
                        var c = r.readUInt8();
                        return t.type = 0 === c ? "noteOff" : "noteOn", t.noteNumber = s, t.velocity = c, 0 === c & amp; & amp;
                        (t.byte9 = !0), t;
                    case 10:
                    ...
                    case 14:
                        return t.type = "pitchBend", t.value = s + (r.readUInt8() & lt; & lt; 7) - 8192, t;
                    default:
        ...
        n.prototype.eof = function () {
            return this.pos & gt; = this.bufferLen
            ...
            return (this.readUInt8() & lt; & lt; 8) + this.readUInt8()
        }, n.prototype.readInt16 = function () {
            var t = this.readUInt16();
            return 32768 & amp;
            t ? t - 65536 : t
        }, n.prototype.readUInt24 = function () {
            return (this.readUInt8() & lt; & lt; 16) + (this.readUInt8() & lt; & lt; 8) + this.readUInt8()
        }, n.prototype.readInt24 = function () {
            var t = this.readUInt24();
            return 8388608 & amp;
            t ? t - 16777216 : t
        }, n.prototype.readUInt32 = function () {
            return (this.readUInt8() & lt; & lt; 24) + (this.readUInt8() & lt; & lt; 16) + (this.readUInt8() & lt; & lt; 8) + this.readUInt8()
            ...
            for (var a = function (t) {
                    var e = new n(t),
                        ...
                        o = e.readUInt16();
                    return 32768 & amp;
                    o ? (a.framesPerSecond = 256 - (o & gt; & gt; 8), a.ticksPerFrame = 255 & amp; o) : a.ticksPerBeat = o, a
                }(i.data), o = [], s = 0; !e.eof() & amp; & amp; s & lt; a.numTracks; s++) {
                var u = e.readChunk();
        ...
        function r(t, e, r) {
            var a, o = new i,
                s = e.length,
                u = null;
            for (a = 0; a & lt; s; a++) !1 !== r.running & amp; & amp;
            (r.running || e[a].running) || (u = null), u = n(o, e[a], u, r.useByte9ForNoteOff);
        ...
        function n(t, e, r, n) {
            ...
            case "timeSignature":
                ...
                var h = 255 & amp;
                Math.floor(Math.log(e.denominator) / Math.LN2);
            ...
            case "sequencerSpecific":
                ...
                break;
            case "unknownMeta":
                null != e.metatypeByte & amp; & amp;
                (t.writeUInt8(255), t.writeUInt8(e.metatypeByte), t.writeVarInt(s.length), t.writeBytes(s));
                break;
            case "sysEx":
            ...
            case "endSysEx":
                ...
                break;
            case "noteOff":
                (u = (!1 !== n & amp; & amp; e.byte9 || n & amp; & amp; 0 == e.velocity ? 144 : 128) | e.channel) !== r & amp; & amp;
                t.writeUInt8(u), t.writeUInt8(e.noteNumber), t.writeUInt8(e.velocity);
                break;
            case "noteOn":
                (u = 144 | e.channel) !== r & amp; & amp;
                t.writeUInt8(u), t.writeUInt8(e.noteNumber), t.writeUInt8(e.velocity);
                break;
            case "noteAftertouch":
                (u = 160 | e.channel) !== r & amp; & amp;
                t.writeUInt8(u), t.writeUInt8(e.noteNumber), t.writeUInt8(e.amount);
                break;
            case "controller":
                (u = 176 | e.channel) !== r & amp; & amp;
                t.writeUInt8(u), t.writeUInt8(e.controllerType), t.writeUInt8(e.value);
                break;
            case "programChange":
                (u = 192 | e.channel) !== r & amp; & amp;
                t.writeUInt8(u), t.writeUInt8(e.programNumber);
                break;
            case "channelAftertouch":
                (u = 208 | e.channel) !== r & amp; & amp;
                t.writeUInt8(u), t.writeUInt8(e.amount);
                break;
            case "pitchBend":
                (u = 224 | e.channel) !== r & amp; & amp;
                t.writeUInt8(u);
                var f = 8192 + e.value,
                    p = 127 & amp;
                f, l = f & gt; & gt;
        ...
        i.prototype.writeUInt8 = function (t) {
            ...
            var e, r = t.length,
                n = [];
            for (e = 0; e & lt; r; e++) n.push(t.codePointAt(e));
            this.writeBytes(n)
        }, i.prototype.writeVarInt = function (t) {
            if (t & lt; 0) throw "Cannot write negative variable-length integer";
            if (t & lt; = 127) this.writeUInt8(t);
            else {
                var e = t,
                    r = [];
                for (r.push(127 & amp; e), e & gt; & gt; = 7; e;) {
                    var n = 127 & amp;
                    e | 128;
                    r.push(n), e & gt; & gt; = 7
                }
            ...
            for (function (t, e, r) {
                    var n = null == e.format ? 1 : e.format,
                        a = 128;
                    e.timeDivision ? a = e.timeDivision : e.ticksPerFrame & amp; & amp;
                    e.framesPerSecond ? a = -(255 & amp; e.framesPerSecond) & lt; & lt;
                    8 | 255 & amp;
                    ticksPerFrame: e.ticksPerBeat & amp; & amp;
                    (a = 32767 & amp; e.ticksPerBeat);
                    var o = new i;
                    o.writeUInt16(n), o.writeUInt16(r), o.writeUInt16(a), t.writeChunk("MThd", o.buffer)
                }(u, a, s), n = 0; n & lt; s; n++) r(u, o[n], e);
            return u.buffer
        }
    }, function (t, e, r) {
        "use strict";
        var n = this & amp; & amp;
        this.__spreadArrays || function () {
            for (var t = 0, e = 0, r = arguments.length; e & lt; r; e++) t += arguments[e].length;
            var n = Array(t),
                i = 0;
            for (e = 0; e & lt; r; e++)
                for (var a = arguments[e], o = 0, s = a.length; o & lt; s; o++, i++) n[i] = a[o];
            return n
        }, i = this & amp; & amp;
        this.__importDefault || function (t) {
            return t & amp; & amp;
            t.__esModule ? t : {
                default: t
            }
        ...
        function u(t) {
            return s.default(t.notes.map(function (e) {
                return function (t, e) {
                    return [{
            ...
            var e = {
                ...
                tracks: n([n([{
                    ...
                    return n([(e = t.name, {
                        ...
                        for (var e = [], r = 0; r & lt; 127; r++) t.controlChanges.hasOwnProperty(r) & amp; & amp;
        ...
        function i(t, e) {
            ...
            return function t(e, r, n) {
                ...
                for (var i = 0; i & lt; e.length; i++) {
                    var a = e[i];
                    n & gt; - 1 & amp; & amp;
                    Array.isArray(a) ? t(a, r, n) : r.push(a)
                }
                return r
            }(t, [], e)
        }
        ...
        var n = r(2),
            ...
            h = function () {
                    ...
                    if (this.instrument = new s.Instrument(t, this), this.channel = 0, t) {
                        for (var i = t.filter(function (t) {
                                ...
                                var e = o.findIndex(function (e) {
                                    return e.noteNumber === t.noteNumber & amp; & amp;
                                    e.absoluteTime & gt; = t.absoluteTime
                                });
                                if (-1 !== e) {
                ...
                return t.prototype.addNote = function (t) {
                    ...
                    var e = this;
                    for (var r in this.name = t.name, this.channel = t.channel, this.instrument = new s.Instrument(void 0, this), this.instrument.fromJSON(t.instrument), t.controlChanges) t.controlChanges[r] & amp; & amp;
                    ...
                    for (var t = {}, e = 0; e & lt; 127; e++) this.controlChanges.hasOwnProperty(e) & amp; & amp;
        ...
        var n = r(13),
            ...
            a = function () {
                ...
                return Object.defineProperty(t.prototype, "name", {
                    ...
                    set: function (t) {
                        var e = n.instrumentByPatchID.indexOf(t); - 1 !== e & amp; & amp;
                        (this.number = e)
                    },
                    enumerable: !0,
                    configurable: !0
        ...
        var i, a, o = (i = /^([a-g]{1}(?:b|#|x|bb)?)(-?[0-9]+)/i, a = {
                cbb: -2,
                cb: -1,
                c: 0,
                "c#": 1,
